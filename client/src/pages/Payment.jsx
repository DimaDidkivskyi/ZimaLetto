                ...
                <div className="payment__inner">
                    ...
                    <div className="payment__item">
                        ...
                        <p>
                            ...
                            debit and bank check cards, your payment will debit
                    ...
                    <div className="payment__item">
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                Republic of Korea, Liberia, Libya, Myanmar,
                                Nigeria, Russia, Sierra Leone, Somalia, Sudan
                                and Syria.
                            </li>
                        </ul>
                    </div>
                    <div className="payment__item">
                        ...
                        <p>
                            Make sure that your billing name and address match
                            the credit card you're using for payment. We reserve
                            the right to cancel any order that does not match
                            these criteria.
                        </p>
                    </div>
                    <div className="payment__item">
                        ...
                        <p>
                            Yes, Zimaletto accepts PayPal payments. Please note
                            that if you are using PayPal as your payment option,
                            you will continue through the standard checkout
                            process. Once you click to submit your order, you
                            will be redirected to PayPal.com to complete your
                            payment. You will have 25 minutes to complete the
                            checkout process and your order will not be
                            submitted until you have finished the process on
                            PayPal.com. <br />
                    ...
                    <div className="payment__item">
                        ...
                        <p>
                            Taxes will be charged based on the applicable state
                            and local percentage and price of your merchandise
                            total and, where required by law, on shipping and
                            handling charges.
                        </p>
                    </div>
