            ...
            <div className="container">
                ...
                <div className="shipping__item">
                    ...
                    <p>
                        ...
                        holidays. Please allow up to two business days
                        processing time in addition to standard delivery time
                        based on your selected shipping method.
                    </p>
                    <p>
                        Please note, during high volume times such as holidays
                        and special sales, there may be a slight delay in order
                        processing. Your business is important to us, and we’ll
                        make every effort to process your order as soon as
                        possible.
                    </p>
                </div>
                <div className="shipping__item">
                    ...
                    <p>
                        ...
                        $100 and Kids' orders over $75. By becoming a ShopRunner
                        member, you can receive free 2-day shipping and free
                ...
                <div className="shipping__item">
                    ...
                    <p>
                        ...
                        orders must be received and all payments must be cleared
                        by 12:00 PM EST in order to be processed on the same
                        day. Orders placed after 12:00 PM EST, on weekends
                        and/or holidays will arrive within two business days for
                        UPS Overnight Shipping, and three business days for UPS
                        Second Day Shipping.
                    </p>
                    <p>
                        We also do not offer Overnight or Second Day shipping to
                        Canada, Alaska, Hawaii, Puerto Rico, the U.S. Virgin
                ...
                <div className="shipping__item">
                    ...
                    <p>
                        ...
                        a premium gift box and secure it with a ribbon for
                        $5.00. Multiple items within a gift order will be
                        presented in one gift box; however some items cannot be
                        placed in a gift box due to size and weight.
                    </p>
                    <p>
                        If you would like to send gifts to different addresses,
                ...
                <div className="shipping__item">
                    ...
                    <p>
                        ...
                        unlimited free 2-day shipping and free returns on all
                        eligible items from Tommy.com.
                    </p>
                    <p>
                        Items that are ShopRunner eligible are indicated by the
                        ShopRunner logo within the product listing. Fragrance
                        and luggage products are not eligible for ShopRunner;
                        however, we do provide complimentary free UPS Ground
                        Shipping on these items. To receive ShopRunner benefits,
                        you must remove any ineligible items indicated in
                        shopping bag. ShopRunner is not available for shipments
                        to Canada.
                    </p>
                    <p>
                        If you'd like to become a member, or need more
                        information, visit{" "}
                        <a href="https://www.shoprunner.com/" target="blank">
                            ShopRunner.com.
                        </a>
                    </p>
                </div>
                ...
                <div className="shipping__item">
                    ...
                    <p>
                        ...
                        tampered with or is damaged, please contact your carrier
