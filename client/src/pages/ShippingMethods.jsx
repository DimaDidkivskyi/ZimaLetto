            ...
            <div className="container">
                <div className="shipping__inner">
                    ...
                    <div className="shipping__item">
                        <h3>Free shipping</h3>
                        <p>
                            Zimaletto offers free shipping on orders of $100.00
                            or more and free shipping on Kids’ orders of $75.00
                            or more. This promotion applies to deliveries within
                            the 48 contiguous United States via standard ground
                            shipping.
                        </p>
                        <p>
                            For your convenience, we offer flat rate shipping
                            which is determined by your location and preferred
                            transit time. We apologize for the inconvenience,
                            but we do not ship to P.O. boxes at this time.
                        </p>
                        <p>
                    ...
                    <div className="shipping__item">
                        ...
                        <ul>
                            ...
                            <div className="shipping__content">
                                <p>
                                    Orders to Alaska, Hawaii, Guam, Puerto Rico
                    ...
                    <div className="shipping__item">
                        ...
                        <p>
                            ...
                            expedited shipping deadline, your order must be
                            placed and your payment must be authorized before
                            12PM EST. All orders placed after this time will be
                            processed the following business day. Please allow
                            up to two business days processing time in addition
                            to standard delivery time based on your selected
                            shipping method. Note that certain items are
                            excluded from overnight or Second Day shipping.
                        </p>
                    </div>
                    <div className="shipping__item">
